...
for f in FILES:
    ...
    zorbacmd = "zorba -i -r -f -q ../xbin/zorba.xqy -e MARCXMLLOC:=" + f + " > ../data/" + fname
    
    xresult, xerrors = Popen([zorbacmd], stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True).communicate()
    if xresult == "":
